...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/07 04:57:48 by aymhabib          #+#    #+#             */
/*   Updated: 2019/07/07 05:42:40 by aymhabib         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_colorpanel(t_fdf *fdf, int x, int y)
{
	...
	else if (y >= 10 && y <= 28 && x >= 226 && x <= 244)
		ft_setcolor(fdf, 0xFFFF33);
